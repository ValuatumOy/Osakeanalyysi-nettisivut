...
// this module on the legacy Express server (where the SDK packages are
// absent from server/node_modules) never happens — callers only require
// server/aws/* when the corresponding env vars (ORDERS_TABLE, REPORT_PDF_BUCKET, …) are set.
